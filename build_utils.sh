...
# The certify_bootimg script will be execuated on a server during the official
# certification process. Dry running the process here so we can catch related
# issues early.
