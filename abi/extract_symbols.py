...
def main():
  ...
  parser.add_argument(
      ...
      help=(
          "Do not group symbols by module. When coupled with --additions-only,"
          " the unused symbols are sorted with all the symbols"
      ),
  )
  ...
  parser.add_argument(
      ...
      help=(
          "Do not process modules matching the filter. Can be passed multiple"
          " times."
      ),
  )
  ...
  if args.print_modules:
    ...
    if gki_modules:
      print(
          "These modules have *NOT* been considered when creating the symbol"
          " list:"
      )
      print(
          "  "
