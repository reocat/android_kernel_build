...
As an example of (1), consider the [fwnode
...
2. If it is a straight forward symbol difference between your kernel and the GKI
...
3. Sometimes a symbol is deleted in a tree and you also want to delete it in
    ...
    **NOTE:** Do not copy-paste tabs
    ...
    c. You will get a short list of commits. The first one is probably the one
