...
def main() -> int:
    ...
    arg_parser.add_argument("file", nargs='?', default="vmlinux.o",
                            type=existing_file)
    ...
    # TODO(maennich): make kernel_component_factory _raise_ a
    # KernelComponentCreationError (needs to be dealt with in multithreaded
    # context)
    error = comp.get_error()
    if error != "":
        logging.error(error)
