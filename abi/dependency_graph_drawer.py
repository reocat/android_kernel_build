...
def _read_graph(
    ...
    with adjacency_list_file.open(encoding="utf-8") as adjacency_list:
        try:
...
def main():
    ...
    adjacency_list = _read_graph(args.adjacency_list_file)
    # Create graph visualization.
    _create_graphviz(adjacency_list, args.output, args.colors)
