...
class RepoManifestParser:
    ...
    # fixup_groups: list of projects with paths fixed up below project_prefix
    fixup_groups: set[str] | None
    # fixup_groups: list of projects with paths untouched
    ...
    def _match_group_internal(self, project: xml.dom.minidom.Element, expect_groups: set[str] | None):
