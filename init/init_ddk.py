...
class KleafProjectSetter:
    ...
    def _handle_kleaf_repo_git_projects(self) -> None:
        ...
        superproject_manager = None
        match self.superproject_tool:
            case "repo":
                superproject_manager = RepoWrapper(
        ...
        if superproject_manager:
            superproject_manager.update_manifest()
            self._projects_synced = superproject_manager.do_sync()
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        If --superproject_tool is repo, --sync=no means the program will skip
