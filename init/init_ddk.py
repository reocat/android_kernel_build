...
class KleafProjectSetter:
  ...
  def _symlink_tools_bazel(self):
    ...
    # Prepare the location and clean up if neccesary
  ...
  def _generate_module_bazel(self):
    ...
    with open(module_bazel, "w", encoding="utf-8") as f:
      ...
      f.write(_MODULE_BAZEL_CONTENT_TEMPLATE.format(
...
if __name__ == "__main__":
  ...
  def build_id(id_: str):
    if not (id_.isdecimal() or (id_[0] == "P" and id_[1:].isdecimal())):
