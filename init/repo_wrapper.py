...
class RepoWrapper:
    ...
    def run(self) -> ProjectSyncStates:
        ...
        Returns:
            set of ProjectSyncState, each describing the orignal
            path, fixed up path, and whether they are was synced.
        """
    ...
    def _populate_kleaf_repo_manifest(self) -> set[ProjectState]:
        ...
        Returns:
            keys are original paths, values are fixed up paths, relative to
            repo root.
        """
