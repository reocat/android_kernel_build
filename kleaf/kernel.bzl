...
def kernel_extracted_symbols(
    ...
    _kernel_extracted_symbols(
        ...
        kmi_symbol_list_symlink = name + "/symlink",
    )

def kernel_update_symbols(
        name,
        src):
    """Update symbols with the given extracted symbols.

    Args:
      name: Name of target.
      src: Name of an [`kernel_extracted_symbols`](#kernel_extracted_symbols) invocation.
    """
    copy_file(
        name = name + "_tool",
