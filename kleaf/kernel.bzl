...
def _kernel_env_impl(ctx):
    ...
    if ctx.attr._config_is_release:
        command += """
    ...
    if ctx.attr._config_is_release[BuildSettingInfo].value:
...
_kernel_env = rule(
    ...
    attrs = {
        ...
        "_config_is_release": attr.label(default = "//build/kernel/kleaf:config_release"),
        "_debug_print_scripts": attr.label(default = "//build/kernel/kleaf:debug_print_scripts"),
...
def _kernel_config_impl(ctx):
    ...
    scmversion_command = ""
    if not ctx.attr._config_is_release[BuildSettingInfo].value:
        scmversion_command = """
