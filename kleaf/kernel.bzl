...
load("//build/kernel/kleaf/impl:kernel_filegroup_declaration.bzl", _kernel_filegroup_declaration = "kernel_filegroup_declaration")
...
kernel_filegroup_declaration = _kernel_filegroup_declaration
