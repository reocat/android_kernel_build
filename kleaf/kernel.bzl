...
def kernel_build_and_abi(
    ...
    |build_abi.sh equivalent            |Bazel command                                          |
    |-----------------------------------|-------------------------------------------------------|
    |`build_abi.sh --update_symbol_list`|`bazel run kernel_aarch64_abi_update_symbol_list`[1]   |
    |-----------------------------------|-------------------------------------------------------|
    ...
    1. The command updates `kmi_symbol_list` but it does not update
      ...
      command.
    2. Order matters, and the two commands cannot run in parallel. This is
