...
load("//build/kernel/kleaf/impl:kernel_unarchived_uapi_headers.bzl", _kernel_unarchived_uapi_headers = "kernel_unarchived_uapi_headers")
...
kernel_unarchived_uapi_headers = _kernel_unarchived_uapi_headers
