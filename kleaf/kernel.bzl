...
def kernel_build_abi(
    ...
    - kernel_aarch64_abi_diff
      - Building this target compares the ABI with STG.
      - Running this target prints the STG ABI diff short report.
    - kernel_aarch64_abi_diff_legacy
      - Building this target compares the ABI with legacy `abidiff`.
    ...
    |-----------------------------------|-------------------------------------------------------|-----------------------------------------------------------------------|
    |`build_abi.sh --print_report`      |`bazel build kernel_aarch64_abi && \\`                 |Extract the ABI and compare it,                                        |
    ...
    1. The command updates `kmi_symbol_list` but it does not update
      ...
      command.
    2. The Bazel command extracts the ABI and/or compare the ABI like the
