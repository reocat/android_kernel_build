...
def _kernel_config_impl(ctx):
    ...
    # Note: this is a path relative to $PWD.
    ...
    if ctx.attr.trim_nonlisted_kmi:
        ...
        # $PWD/<intermediates>/abi_symobllist.raw relative to ${KERNEL_DIR}.
        # That is:
        #   ROOT_DIR=$PWD
        ...
        #   |- <execroot>                     # This is $PWD
        #       |- common -> $ROOT_DIR/common # symlink to $abs_srctree
