...
load("//build/kernel/kleaf/impl:ddk/ddk_conditional_filegroup.bzl", _ddk_conditional_filegroup = "ddk_conditional_filegroup")
...
ddk_conditional_filegroup = _ddk_conditional_filegroup
