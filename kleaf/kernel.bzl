...
def _kernel_env_impl(ctx):
    ...
    if not ctx.attr._config_is_skip_scm[BuildSettingInfo].value:
        command += """
...
_kernel_env = rule(
    ...
    attrs = {
        ...
        "_config_is_skip_scm": attr.label(default = "//build/kernel/kleaf:config_skip_scm"),
        "_debug_print_scripts": attr.label(default = "//build/kernel/kleaf:debug_print_scripts"),
...
def _kernel_config_impl(ctx):
    ...
    scmversion_command = ""
    if ctx.attr._config_is_skip_scm[BuildSettingInfo].value:
        scmversion_command = """
...
def _kernel_module_impl(ctx):
    ...
    if not ctx.attr._config_skip_scm[BuildSettingInfo].value:
