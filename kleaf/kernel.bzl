...
load("//build/kernel/kleaf/impl:checkpatch.bzl", _checkpatch = "checkpatch", _checkpatch_presubmit = "checkpatch_presubmit")
...
checkpatch_presubmit = _checkpatch_presubmit
