...
load("//build/kernel/kleaf/impl:image/super_image.bzl", _super_image = "super_image", _unsparsed_super_image = "unsparsed_super_image")
...
unsparsed_super_image = _unsparsed_super_image
