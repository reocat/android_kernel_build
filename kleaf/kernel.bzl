...
load("//build/kernel/kleaf/impl:ddk/analyze_ddk_headers.bzl", _analyze_ddk_headers = "analyze_ddk_headers")
...
load("//build/kernel/kleaf/impl:ddk/expand_ddk_headers.bzl", _expand_ddk_headers = "expand_ddk_headers")
...
analyze_ddk_headers = _analyze_ddk_headers
ddk_headers = _ddk_headers
ddk_module = _ddk_module
expand_ddk_headers = _expand_ddk_headers
