...
def kernel_build(
    ...
    Args:
        ...
        base_kernel: A rule referring to the base kernel build. The rule must conform to
          [`KernelFilesInfo`](#kernelfilesinfo).
          ...
          - A `filegroup` of prebuilts, e.g.
            ```
            load("//build/kleaf:common_kernels.bzl, "aarch64_outs")
            filegroup(
              name = "base_kernel_prebuilts",
              srcs = aarch64_outs,
            )
            ```
