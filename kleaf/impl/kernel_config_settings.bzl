...
def _kernel_env_get_config_tags(ctx, upper_rule_name, defconfig_fragments):
    ...
    ctx.actions.run(
        ...
        arguments = [args],
        mnemonic = "{}CommonConfigTags".format(upper_rule_name),
    ...
    ctx.actions.run(
        ...
        executable = ctx.executable._cache_dir_config_tags,
        arguments = [args],
        mnemonic = "{}ConfigTags".format(upper_rule_name),
