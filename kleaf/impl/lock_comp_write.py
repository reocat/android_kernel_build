...
"""Lock a file, compare with stdin, then write stdin to the file if the file is
empty or does not exist.

Usage:
  lock_comp_write <lock_file> < <in_file>

The script does the following:
- Put a lock on lock_file, creating it if it does not exist
- If the file is empty, copy the content of stdin into lock_file.
- Otherwise, compare stdin with lock_file, and exit abnormally if the content
  mismatches.
"""
