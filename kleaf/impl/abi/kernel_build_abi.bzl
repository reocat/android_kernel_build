...
def _define_abi_definition_targets(
    ...
    exec(
        name = name + "_stg_nodiff_update",
        data = [
            name + "_extracted_symbols",
            name + "_stg_update_definition",
            kmi_symbol_list,
        ],
        script = """
              # Ensure that symbol list is updated
            ...
            package = native.package_name(),
            update_symbol_list_label = name + "_update_symbol_list",
            update_definition = name + "_stg_update_definition",
        ),
        **kwargs
    )
    ...
    exec(
        ...
        script = """
            ...
            nodiff_update = name + "_stg_nodiff_update",
        ),
        **kwargs
    )
