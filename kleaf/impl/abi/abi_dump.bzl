...
def _stg_file_filter(ctx):
    ...
    #
    # TODO(b/325423395): Always use file filters when STG starts handling file
    #                    filters with Rust CUs.
    return "" if ctx.attr._rust[BuildSettingInfo].value else "--files '*.h'"
