...
def _dependency_graph_extractor_impl(ctx):
    ...
    srcs = [vmlinux]
    if not ctx.attr.external_modules_only:
...
dependency_graph_extractor = rule(
    ...
    attrs = {
        ...
        "external_modules_only": attr.bool(
...
def dependency_graph(
    ...
    Args:
        ...
        external_modules_only: Whether the analysis should made for only external modules.
    ...
    dependency_graph_extractor(
        ...
        external_modules_only = external_modules_only,
        **kwargs
    )
