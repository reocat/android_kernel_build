...
def kernel_build(
    ...
    if unstable_kmi_symbol_list:
        all_kmi_symbol_lists.append(unstable_kmi_symbol_list)
...
_kernel_build = rule(
    ...
    attrs = {
        ...
        "combined_abi_symbollist": attr.label(
            doc = """The **combined** `abi_symbollist` file is the sum of `kmi_symbol_list` and
                `additional_kmi_symbol_lists` minus the `unstable_kmi_symbol_list`.""",
            allow_files = True,
        ),
