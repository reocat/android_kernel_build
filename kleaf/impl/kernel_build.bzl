...
def kernel_build(
        ...
        modules_prepare_force_headers_generation = None,
        **kwargs):
    ...
    Args:
        ...
        modules_prepare_force_headers_generation: If `True` it forces generation of
    ...
    modules_prepare(
        ...
        trim_nonlisted_kmi = trim_nonlisted_kmi,
        force_headers_generation = modules_prepare_force_headers_generation,
        **internal_kwargs
    )
