...
def kernel_build(
        ...
        kconfig_ext = None,
        dtstree = None,
        allow_absolute_paths_in_config = None,
    ...
    Args:
        ...
        allow_absolute_paths_in_config: If true, `.config` does not contain
    ...
    kernel_config(
        ...
        allow_absolute_paths_in_config = allow_absolute_paths_in_config,
        lto = lto,
        defconfig_fragments = defconfig_fragments,
        **internal_kwargs
    )
