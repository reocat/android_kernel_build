...
def _kmi_symbol_list_violations_check(ctx, modules_staging_archive):
    ...
    out = ctx.actions.declare_file(
        "{}_kmi_symbol_list_violations/kmi_symbol_list_violations_checked".format(ctx.attr.name),
    )
    ...
    command += """
        ...
        {check_symbol_protection} --abi-symbol-list {raw_kmi_symbol_list} {intermediates_dir}
