...
CI_TARGET_MAPPING = {
    ...
    "gki_prebuilts": {
        ...
        "download_configs": [
            ...
            {
                "target_suffix": "module_env",
                "mandatory": True,
                "extract": ".",
                "outs_mapping": {
                    # FIXME these should go to ddk_artifacts
                    "kernel_aarch64" + MODULE_ENV_ARCHIVE_SUFFIX: "kernel_aarch64" + MODULE_ENV_ARCHIVE_SUFFIX,
                },
            },
            {
