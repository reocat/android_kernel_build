...
class ArgWrapper {
 public:
  static std::optional<ArgWrapper> Make(
    ...
    auto extra_args_file = internal_dir / (toolname + "_args.txt");
...
int main(int argc, char* argv[]) {
  ...
  auto internal_symlink = (*internal_dir) / toolname;

  auto arg_wrapper =
      ArgWrapper::Make(internal_symlink, *internal_dir, toolname, argc, argv);
