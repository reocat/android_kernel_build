...
if __name__ == "__main__":
    ...
    absl.flags.DEFINE_string("do_not_use_flagfile_hack", "", "")
    ...
    parser.add_argument("--include_dirs", type=pathlib.Path, nargs="*", default=[])
    parser.add_argument("--module_symvers_list", type=pathlib.Path, nargs="*", default=[])
