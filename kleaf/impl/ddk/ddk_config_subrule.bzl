...
def _ddk_config_subrule_impl(
    ...
    Args:
        ...
        ddk_config_deps: list of targets providing DdkConfigInfo
        extra_defconfigs: extra depset of defconfig files. Lowest priority.
    """

    extra_defconfigs = extra_defconfigs or depset()
    ...
    return DdkConfigInfo(
        ...
        defconfig = depset(
            transitive = [extra_defconfigs] +
                         [dep[DdkConfigInfo].defconfig for dep in ddk_config_deps] +
