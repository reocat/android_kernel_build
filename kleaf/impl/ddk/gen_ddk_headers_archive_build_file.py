...
if __name__ == "__main__":
  ...
  parser.add_argument("--hdrs", type=pathlib.Path, nargs="*", default=[])
  parser.add_argument(
      "--linux-includes", type=pathlib.Path, nargs="*", default=[]
  )
  parser.add_argument("--includes", type=pathlib.Path, nargs="*", default=[])
