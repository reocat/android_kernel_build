...
This script must be executed with `bazel run`, or executed directly
when CWD=workspace root.
"""
import argparse
import logging
import pathlib
...
class SanitizeInputs(object):
    def __init__(self, input: TextIO, output: TextIO,
        ...
        self._workspace_dir = pathlib.Path(os.environ.get("BUILD_WORKSPACE_DIRECTORY", os.getcwd()))
