...
def _config_lto(ctx):
    ...
    if lto_config_flag == "none":
        ...
        if ctx.attr._config_is_fast[BuildSettingInfo].value:
            lto_configs += [
                _config.enable_if("LTO", "LTO_CLANG"),
                _config.disable_if("LTO", "LTO_NONE"),
                _config.enable_if("LTO", "LTO_CLANG_THIN"),
                _config.disable_if("LTO", "LTO_CLANG_FULL"),
                _config.enable_if("LTO", "THINLTO"),
            ]
