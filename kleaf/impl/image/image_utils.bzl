...
def _strip_modules(ctx):
    """ Utility to infer the value of strip_modules from `kernel_build`.
    ...
    _strip_modules = _kernel_build[KernelBuildExtModuleInfo].strip_modules
    return _strip_modules
