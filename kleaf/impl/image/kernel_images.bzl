...
def kernel_images(
    ...
    if build_any_boot_image:
        ...
        if avb_sign_boot_img and (avb_boot_partition_size == None or
                                  avb_boot_key == None or avb_boot_algorithm == None or
                                  avb_boot_partition_name == None):
            fail("avb_sign_boot_img is true, but one of [avb_boot_partition_size, avb_boot_key," +
                 " avb_boot_algorithm, avb_boot_partition_name] is `None`.")
