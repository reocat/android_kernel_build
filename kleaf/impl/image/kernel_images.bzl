...
def kernel_images(
    ...
    Args:
        ...
        ramdisk_compression: if set to `True`, any ramdisks generated will be lz4
    ...
    if build_initramfs:
        ...
        if ramdisk_compression_args and ramdisk_compression != "lz4":
            fail(
                "ramdisk_compress_args provided but ramdisk_compression={} is different to lz4.".format(
                    ramdisk_compression,
                ),
            )
