...
def kernel_images(
    ...
    Args:
        ...
        vendor_dlkm_insmod_cfgs: Directory for insmod config files that need to be copied to `vendor_dlkm.img`.
    ...
    if build_vendor_dlkm:
        ...
        vendor_dlkm_image(
            ...
            vendor_dlkm_insmod_cfgs = vendor_dlkm_insmod_cfgs,
