...
def _system_dlkm_image_impl(ctx):
    ...
    for fs_type in system_dlkm_fs_types:
        ...
        """.format(
            ...
            system_dlkm_staging_dir = system_dlkm_staging_dir,
            system_dlkm_flatten_img = system_dlkm_flatten_img.path if ctx.attr.build_system_dlkm_flatten_image else None,
            system_dlkm_flatten_img_name = system_dlkm_flatten_img_name if ctx.attr.build_system_dlkm_flatten_image else None,
