...
def _default_target_configs():
    ...
    aarch64_abi_stg_definition = native.glob(["android/abi_gki_aarch64.stg"])
    aarch64_abi_stg_definition = aarch64_abi_stg_definition[0] if aarch64_abi_stg_definition else None
    ...
    aarch64_common = {
        ...
        "abi_stg_definition": aarch64_abi_stg_definition,
