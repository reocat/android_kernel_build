...
load(":build_config_repo.bzl", "sanitize_path")
...
load(
    ...
    KERNEL_AARCH64_BUILD_SYSTEM_DLKM = "BUILD_SYSTEM_DLKM",
    KERNEL_AARCH64_KMI_SYMBOL_LIST = "KMI_SYMBOL_LIST",
    KERNEL_AARCH64_KMI_SYMBOL_LIST_STRICT_MODE = "KMI_SYMBOL_LIST_STRICT_MODE",
    KERNEL_AARCH64_MODULES_BLOCKLIST = "MODULES_BLOCKLIST",
    KERNEL_AARCH64_MODULES_LIST = "MODULES_LIST",
    KERNEL_AARCH64_MODULES_OPTIONS = "MODULES_OPTIONS",
    KERNEL_AARCH64_TRIM_NONLISTED_KMI = "TRIM_NONLISTED_KMI",
    KERNEL_AARCH64_VENDOR_DLKM_MODULES_BLOCKLIST = "VENDOR_DLKM_MODULES_BLOCKLIST",
    KERNEL_AARCH64_VENDOR_DLKM_MODULES_LIST = "VENDOR_DLKM_MODULES_LIST",
)
load(
    "@build.config.gki-debug.aarch64//:dict.bzl",
    KERNEL_AARCH64_DEBUG_ADDITIONAL_KMI_SYMBOL_LISTS = "ADDITIONAL_KMI_SYMBOL_LISTS",
    KERNEL_AARCH64_DEBUG_BUILD_SYSTEM_DLKM = "BUILD_SYSTEM_DLKM",
    ...
    KERNEL_AARCH64_DEBUG_MODULES_BLOCKLIST = "MODULES_BLOCKLIST",
    KERNEL_AARCH64_DEBUG_MODULES_LIST = "MODULES_LIST",
    KERNEL_AARCH64_DEBUG_MODULES_OPTIONS = "MODULES_OPTIONS",
    KERNEL_AARCH64_DEBUG_TRIM_NONLISTED_KMI = "TRIM_NONLISTED_KMI",
    KERNEL_AARCH64_DEBUG_VENDOR_DLKM_MODULES_BLOCKLIST = "VENDOR_DLKM_MODULES_BLOCKLIST",
    KERNEL_AARCH64_DEBUG_VENDOR_DLKM_MODULES_LIST = "VENDOR_DLKM_MODULES_LIST",
)
load(
    "@build.config.gki.x86_64//:dict.bzl",
    KERNEL_X86_64_ADDITIONAL_KMI_SYMBOL_LISTS = "ADDITIONAL_KMI_SYMBOL_LISTS",
    KERNEL_X86_64_BUILD_SYSTEM_DLKM = "BUILD_SYSTEM_DLKM",
    KERNEL_X86_64_KMI_SYMBOL_LIST = "KMI_SYMBOL_LIST",
    KERNEL_X86_64_KMI_SYMBOL_LIST_STRICT_MODE = "KMI_SYMBOL_LIST_STRICT_MODE",
    KERNEL_X86_64_MODULES_BLOCKLIST = "MODULES_BLOCKLIST",
    KERNEL_X86_64_MODULES_LIST = "MODULES_LIST",
    KERNEL_X86_64_MODULES_OPTIONS = "MODULES_OPTIONS",
    KERNEL_X86_64_TRIM_NONLISTED_KMI = "TRIM_NONLISTED_KMI",
    KERNEL_X86_64_VENDOR_DLKM_MODULES_BLOCKLIST = "VENDOR_DLKM_MODULES_BLOCKLIST",
    KERNEL_X86_64_VENDOR_DLKM_MODULES_LIST = "VENDOR_DLKM_MODULES_LIST",
)
load(
    "@build.config.gki-debug.x86_64//:dict.bzl",
    KERNEL_X86_64_DEBUG_ADDITIONAL_KMI_SYMBOL_LISTS = "ADDITIONAL_KMI_SYMBOL_LISTS",
    KERNEL_X86_64_DEBUG_BUILD_SYSTEM_DLKM = "BUILD_SYSTEM_DLKM",
    ...
    KERNEL_X86_64_DEBUG_MODULES_BLOCKLIST = "MODULES_BLOCKLIST",
    KERNEL_X86_64_DEBUG_MODULES_LIST = "MODULES_LIST",
    KERNEL_X86_64_DEBUG_MODULES_OPTIONS = "MODULES_OPTIONS",
    KERNEL_X86_64_DEBUG_TRIM_NONLISTED_KMI = "TRIM_NONLISTED_KMI",
    KERNEL_X86_64_DEBUG_VENDOR_DLKM_MODULES_BLOCKLIST = "VENDOR_DLKM_MODULES_BLOCKLIST",
    KERNEL_X86_64_DEBUG_VENDOR_DLKM_MODULES_LIST = "VENDOR_DLKM_MODULES_LIST",
)

_ARCH_VALUES = {
    "kernel_aarch64": {
        "ADDITIONAL_KMI_SYMBOL_LISTS": KERNEL_AARCH64_ADDITIONAL_KMI_SYMBOL_LISTS,
        "BUILD_SYSTEM_DLKM": KERNEL_AARCH64_BUILD_SYSTEM_DLKM,
        "KMI_SYMBOL_LIST": KERNEL_AARCH64_KMI_SYMBOL_LIST,
        "KMI_SYMBOL_LIST_STRICT_MODE": KERNEL_AARCH64_KMI_SYMBOL_LIST_STRICT_MODE,
        "MODULES_BLOCKLIST": KERNEL_AARCH64_MODULES_BLOCKLIST,
        "MODULES_LIST": KERNEL_AARCH64_MODULES_LIST,
        "MODULES_OPTIONS": KERNEL_AARCH64_MODULES_OPTIONS,
        "TRIM_NONLISTED_KMI": KERNEL_AARCH64_TRIM_NONLISTED_KMI,
        "VENDOR_DLKM_MODULES_BLOCKLIST": KERNEL_AARCH64_VENDOR_DLKM_MODULES_BLOCKLIST,
        "VENDOR_DLKM_MODULES_LIST": KERNEL_AARCH64_VENDOR_DLKM_MODULES_LIST,
    },
    "kernel_aarch64_debug": {
        "ADDITIONAL_KMI_SYMBOL_LISTS": KERNEL_AARCH64_DEBUG_ADDITIONAL_KMI_SYMBOL_LISTS,
        "BUILD_SYSTEM_DLKM": KERNEL_AARCH64_DEBUG_BUILD_SYSTEM_DLKM,
        ...
        "MODULES_BLOCKLIST": KERNEL_AARCH64_DEBUG_MODULES_BLOCKLIST,
        "MODULES_LIST": KERNEL_AARCH64_DEBUG_MODULES_LIST,
        "MODULES_OPTIONS": KERNEL_AARCH64_DEBUG_MODULES_OPTIONS,
        "TRIM_NONLISTED_KMI": KERNEL_AARCH64_DEBUG_TRIM_NONLISTED_KMI,
        "VENDOR_DLKM_MODULES_BLOCKLIST": KERNEL_AARCH64_DEBUG_VENDOR_DLKM_MODULES_BLOCKLIST,
        "VENDOR_DLKM_MODULES_LIST": KERNEL_AARCH64_DEBUG_VENDOR_DLKM_MODULES_LIST,
    },
    "kernel_x86_64": {
        "ADDITIONAL_KMI_SYMBOL_LISTS": KERNEL_X86_64_ADDITIONAL_KMI_SYMBOL_LISTS,
        "BUILD_SYSTEM_DLKM": KERNEL_X86_64_BUILD_SYSTEM_DLKM,
        "KMI_SYMBOL_LIST": KERNEL_X86_64_KMI_SYMBOL_LIST,
        "KMI_SYMBOL_LIST_STRICT_MODE": KERNEL_X86_64_KMI_SYMBOL_LIST_STRICT_MODE,
        "MODULES_BLOCKLIST": KERNEL_X86_64_MODULES_BLOCKLIST,
        "MODULES_LIST": KERNEL_X86_64_MODULES_LIST,
        "MODULES_OPTIONS": KERNEL_X86_64_MODULES_OPTIONS,
        "TRIM_NONLISTED_KMI": KERNEL_X86_64_TRIM_NONLISTED_KMI,
        "VENDOR_DLKM_MODULES_BLOCKLIST": KERNEL_X86_64_VENDOR_DLKM_MODULES_BLOCKLIST,
        "VENDOR_DLKM_MODULES_LIST": KERNEL_X86_64_VENDOR_DLKM_MODULES_LIST,
    },
    "kernel_x86_64_debug": {
        "ADDITIONAL_KMI_SYMBOL_LISTS": KERNEL_X86_64_DEBUG_ADDITIONAL_KMI_SYMBOL_LISTS,
        "BUILD_SYSTEM_DLKM": KERNEL_X86_64_DEBUG_BUILD_SYSTEM_DLKM,
        ...
        "MODULES_BLOCKLIST": KERNEL_X86_64_DEBUG_MODULES_BLOCKLIST,
        "MODULES_LIST": KERNEL_X86_64_DEBUG_MODULES_LIST,
        "MODULES_OPTIONS": KERNEL_X86_64_DEBUG_MODULES_OPTIONS,
        "TRIM_NONLISTED_KMI": KERNEL_X86_64_DEBUG_TRIM_NONLISTED_KMI,
        "VENDOR_DLKM_MODULES_BLOCKLIST": KERNEL_X86_64_DEBUG_VENDOR_DLKM_MODULES_BLOCKLIST,
        "VENDOR_DLKM_MODULES_LIST": KERNEL_X86_64_DEBUG_VENDOR_DLKM_MODULES_LIST,
    },
}
    ...
    **Prebuilts**
    ...
    for name, arch_config in _ARCH_CONFIGS.items():
        ...
        kernel_images(
            ...
            build_system_dlkm = _ARCH_VALUES[name]["BUILD_SYSTEM_DLKM"] == "1",
            deps = _filter_out_false([
                sanitize_path(_ARCH_VALUES[name]["MODULES_LIST"], what = name + "_images: MODULES_LIST"),
                sanitize_path(_ARCH_VALUES[name]["MODULES_BLOCKLIST"], what = name + "_images: MODULES_BLOCKLIST"),
                sanitize_path(_ARCH_VALUES[name]["MODULES_OPTIONS"], what = name + "_images: MODULES_OPTIONS"),
                # Skip VENDOR_DLKM_MODULES_LIST and VENDOR_DLKM_MODULES_BLOCKLIST;
                # we never build vendor_dlkm for common kernels.
                # However, this might be useful for device kernel build.
            ]),
        )
