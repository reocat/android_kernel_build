...
class BazelWrapper(object):
    ...
    def _parse_startup_options(self):
        ...
        - absolute_user_root: A string holding bazel build output location
        ...
        if known_startup_options.output_user_root:
            self.absolute_user_root = f"{known_startup_options.output_user_root}"
        else:
