...
$ GKI_BUILD_ID=8728678

# Build with --use_prebuilt_gki=${GKI_BUILD_ID}. Example:
$ tools/bazel run --use_prebuilt_gki=${GKI_BUILD_ID} //gs/google-modules/soc-modules:slider_dist
```
