...
beforn build system starting. Unfortunately, some of automatically debugging and
analysing tools which need static `OUT_DIR` path would be broken.
...
This is only for debugging or analysing which would NOT affect any sandbox or caching
