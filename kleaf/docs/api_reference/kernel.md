...
<pre>
kernel_dtstree(<a href="#kernel_dtstree-name">name</a>, <a href="#kernel_dtstree-srcs">srcs</a>, <a href="#kernel_dtstree-makefile">makefile</a>, <a href="#kernel_dtstree-generated">generated</a>, <a href="#kernel_dtstree-kwargs">kwargs</a>)
</pre>
...
| <a id="kernel_dtstree-generated"></a>generated |  A list of generated files.<br><br>To include these files, use `#include "generated/base_name_of_file.dtsi"` in files in `srcs`. Only append the base name of the file, not the full path, after `generated/`.   |  `None` |
