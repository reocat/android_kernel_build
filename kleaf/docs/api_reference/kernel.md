...
<pre>
dependency_graph_extractor(<a href="#dependency_graph_extractor-name">name</a>, <a href="#dependency_graph_extractor-enable_add_vmlinux">enable_add_vmlinux</a>, <a href="#dependency_graph_extractor-external_modules_only">external_modules_only</a>, <a href="#dependency_graph_extractor-kernel_build">kernel_build</a>,
...
| <a id="dependency_graph_extractor-external_modules_only"></a>external_modules_only |  Whether the analysis should made for only external modules.   | Boolean | optional |  `False`  |
...
<pre>
dependency_graph(<a href="#dependency_graph-name">name</a>, <a href="#dependency_graph-kernel_build">kernel_build</a>, <a href="#dependency_graph-kernel_modules">kernel_modules</a>, <a href="#dependency_graph-colorful">colorful</a>, <a href="#dependency_graph-external_modules_only">external_modules_only</a>, <a href="#dependency_graph-kwargs">kwargs</a>)
</pre>
...
| <a id="dependency_graph-external_modules_only"></a>external_modules_only |  Whether the analysis should made for only external modules.   |  `None` |
