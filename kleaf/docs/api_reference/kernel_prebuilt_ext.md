...
kernel_prebuilt_ext.declare_kernel_prebuilts(<a href="#kernel_prebuilt_ext.declare_kernel_prebuilts-name">name</a>, <a href="#kernel_prebuilt_ext.declare_kernel_prebuilts-download_configs_file">download_configs_file</a>, <a href="#kernel_prebuilt_ext.declare_kernel_prebuilts-local_artifact_path">local_artifact_path</a>,
                                             <a href="#kernel_prebuilt_ext.declare_kernel_prebuilts-target">target</a>)
</pre>
...
| <a id="kernel_prebuilt_ext.declare_kernel_prebuilts-download_configs_file"></a>download_configs_file |  A file that contains `download_configs`.<br><br>If relative, it is interpreted against workspace root.<br><br>At most one of `download_configs` and `download_configs_file` may be set.   | String | optional |  `""`  |
