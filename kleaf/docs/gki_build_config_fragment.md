...
[common-modules/virtual-devices](https://android.googlesource.com/kernel/common-modules/virtual-device/+/refs/heads/android-mainline)).
...
```shell
tools/bazel build //common-modules/virtual-device:virtual_device_aarch64 --gki_build_config_fragment=//common-modules/virtual-device:sample_gki_fragment
```
