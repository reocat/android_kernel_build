...
```shell
$ tools/bazel run <name_of_kernel_build>_config [-- [menuconfig|xconfig|...]]
```
...
# BUILD_CONFIG=common/build.config.gki.x86_64 build/kernel/config.sh xconfig
$ tools/bazel run //common:kernel_x86_64_config -- xconfig
```