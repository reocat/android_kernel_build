...
$ tools/bazel run //private/path/to/sources:tuna_dist -- --flat --dist_dir=out/dist
...
```shell
$ tools/bazel run --lto=none //private/path/to/sources:tuna_dist -- --flat --dist_dir=out/dist
```
