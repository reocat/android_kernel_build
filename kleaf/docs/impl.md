...
* If you are using GKI modules, also add the list of GKI modules you are using
  from `//common:kernel_aarch64`. If you are using building these modules in
  your device kernel build, skip them, because your `kernel_modules_install`
