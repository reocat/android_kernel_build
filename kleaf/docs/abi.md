...
builds all ABI-related artifacts for distribution, and copies them to the given
directory. The exit code reflects whether an ABI change is detected in the
