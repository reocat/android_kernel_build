...
def _handle_python(ctx, py_outs, runtime):
    ...
    return struct(
        ...
        # TODO(b/247624301): Use depset of HermeticToolsInfo.
...
def hermetic_tools(
    ...
    Args:
        ...
        py2_outs: List of tool names that resolved to python 2 binary.
        py3_outs: List of tool names that resolved to python 3 binary.
