...
def _hermetic_tools_impl(ctx):
    ...
    # TODO(b/291816237): Drop this once build.config.common no longer hardcodes
    #   DTC. Use a flag to gradually phase this out because partner kernel_build
    #   may also have hardcoded paths.
