...
def _find_action(ctx, env_or_actions, mnemonic, optional = None, add_local_suffix = None):
    ...
    Args:
        ...
        optional: If True, and no action is found, return None. Otherwise raises
          error.
        add_local_suffix: If True, adds "Local" to the expected mnemonic.
    """
    ...
    asserts.true(action, "No matching action with mnemonic {} found".format(mnemonic))
