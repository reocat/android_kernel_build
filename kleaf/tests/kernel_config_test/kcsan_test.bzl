...
_kcsan_true_default_test = _kcsan_tests[True, "default"]
_kcsan_true_thin_test = _kcsan_tests[True, "thin"]
_kcsan_true_full_test = _kcsan_tests[True, "full"]
_kcsan_true_none_test = _kcsan_tests[True, "none"]
_kcsan_false_default_test = _kcsan_tests[False, "default"]
_kcsan_false_thin_test = _kcsan_tests[False, "thin"]
_kcsan_false_full_test = _kcsan_tests[False, "full"]
_kcsan_false_none_test = _kcsan_tests[False, "none"]
