...
def _make_goals_test_impl(ctx):
    ...
    action = test_utils.find_action(env, "KernelBuild")  # Use "KernelEnv" for KernelEnv
...
def kernel_build_make_goals_test(name):
    ...
    for suffix, test in [
        ...
        test(
            ...
            target_under_test = name + "_build_from_config",  # Use _env for KernelEnv
        ...
        test(
            ...
            target_under_test = name + "_build_from_rule",  # Use _env for KernelEnv
