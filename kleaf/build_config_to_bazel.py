...
_IGNORED_BUILD_CONFIGS = {
    ...
    "SKIP_MRPROPER": r"^(.|\n)*$",
    "SKIP_DEFCONFIG": r"^(.|\n)*$",
    "SKIP_IF_VERSION_MATCHES": r"^(.|\n)*$",
    "SKIP_EXT_MODULES": r"^(.|\n)*$",
    "SKIP_CP_KERNEL_HDR": r"^(.|\n)*$",
    "SKIP_UNPACKING_RAMDISK": r"^(.|\n)*$",
    "POST_DEFCONFIG_CMDS": r"^(.|\n)*$",
    "IN_KERNEL_MODULES": r"^(.|\n)*$",
    "DO_NOT_STRIP_MODULES": r"^(.|\n)*$",
    "AVB_SIGN_BOOT_IMG": r"^(.|\n)*$",
    "AVB_BOOT_PARTITION_SIZE": r"^(.|\n)*$",
    "AVB_BOOT_KEY": r"^(.|\n)*$",
    "AVB_BOOT_ALGORITHM": r"^(.|\n)*$",
    "AVB_BOOT_PARTITION_NAME": r"^(.|\n)*$",
    "MODULES_ORDER": r"^(.|\n)*$",
    "GKI_MODULES_LIST": r"^(.|\n)*$",
    "LZ4_RAMDISK": r"^(.|\n)*$",
    "LZ4_RAMDISK_COMPRESS_ARGS": r"^(.|\n)*$",
    "KMI_STRICT_MODE_OBJECTS": r"^(.|\n)*$",
    "GKI_DIST_DIR": r"^(.|\n)*$",
    "BUILD_GKI_ARTIFACTS": r"^(.|\n)*$",
    "GKI_KERNEL_CMDLINE": r"^(.|\n)*$",
    "AR": r"^(.|\n)*$",
    "ARCH": r"^(.|\n)*$",
    "BRANCH": r"^(.|\n)*$",
    "BUILDTOOLS_PREBUILT_BIN": r"^(.|\n)*$",
    "CC": r"^(.|\n)*$",
    "CLANG_PREBUILT_BIN": r"^(.|\n)*$",
    "CLANG_VERSION": r"^(.|\n)*$",
    "COMMON_OUT_DIR": r"^(.|\n)*$",
    "DECOMPRESS_GZIP": r"^(.|\n)*$",
    "DECOMPRESS_LZ4": r"^(.|\n)*$",
    ...
    "HOSTLDFLAGS": r"^(.|\n)*$",
    "KBUILD_BUILD_HOST": r"^(.|\n)*$",
    "KBUILD_BUILD_TIMESTAMP": r"^(.|\n)*$",
    "KBUILD_BUILD_USER": r"^(.|\n)*$",
    "KBUILD_BUILD_VERSION": r"^(.|\n)*$",
    "KCFLAGS": r"^(.|\n)*$",
    "KCPPFLAGS": r"^(.|\n)*$",
    "KMI_GENERATION": r"^(.|\n)*$",
    "LC_ALL": r"^(.|\n)*$",
    ...
    "TZ": r"^(.|\n)*$",
    "UNSTRIPPED_DIR": r"^(.|\n)*$",
    "UNSTRIPPED_MODULES_ARCHIVE": r"^(.|\n)*$",
    "USERCFLAGS": r"^(.|\n)*$",
    "USERLDFLAGS": r"^(.|\n)*$",
    "_SETUP_ENV_SH_INCLUDED": r"^(.|\n)*$",
