...
#     defined:
#     - AVB_BOOT_PARTITION_SIZE=<size of the boot partition>
#     - AVB_BOOT_KEY=<path to the key used for signing> The Android test key
#     has been uploaded to the kernel/prebuilts/build-tools project here:
#     https://android.googlesource.com/kernel/prebuilts/build-tools/+/refs/heads/master/linux-x86/share/avb
#     - AVB_BOOT_ALGORITHM=<AVB_BOOT_KEY algorithm used>
#
#   BUILD_INITRAMFS
