...
#     - MKBOOTIMG_PATH=<path to the mkbootimg.py script which builds
#     boot.img>
#     - GKI_RAMDISK_PREBUILT_BINARY=<Name of the GKI ramdisk prebuilt which includes
#     the generic ramdisk components like init and the non-device-specific rc
#     files>
#     - VENDOR_RAMDISK_BINARY=<Name of the vendor ramdisk binary which
#     includes the device-specific components of ramdisk like the fstab file and the
