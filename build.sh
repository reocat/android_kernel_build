...
#     location of an optional file containing a list of modules which are blocked
#     from being loaded. This file is copied directly to the staging directory
#     and should be in the format:
#     blocklist module_name
#
#   VENDOR_DLKM_PROPS
