...
if [ -n "${MODULES}" ]; then
  ...
  if [ -n "${BUILD_KO_RAMDISK}" ]; then
    ...
    set -x
    rm -rf ${KO_RAMDISK_STAGING_DIR}
    mkdir -p ${KO_RAMDISK_STAGING_DIR}/lib/modules/kernel/
    cp -r ${MODULES_STAGING_DIR}/lib/modules/*/kernel/* ${KO_RAMDISK_STAGING_DIR}/lib/modules/kernel/
    cp ${MODULES_STAGING_DIR}/lib/modules/*/modules.* ${KO_RAMDISK_STAGING_DIR}/lib/modules/
    cp ${MODULES_STAGING_DIR}/lib/modules/*/modules.order ${KO_RAMDISK_STAGING_DIR}/lib/modules/modules.load
